...
void i2c_init(void)
{
    ...
    esp_intr_alloc_intrstatus(ETS_I2C_EXT0_INTR_SOURCE, ESP_INTR_FLAG_LEVEL3, I2C_STATUS_REGISTER, I2C_STATUS_TIMEOUT, i2c_isr, NULL, &handle);
    i2c_isr_register(I2C_PORT, i2c_isr, NULL, ESP_INTR_FLAG_LEVEL3, &handle);
