...
#define PRESENCE_MEASUREMENT_INTERVAL_S (5*60) // seconds (5 min * 60 s/min)
#define ADDR_LEN 12
...
esp_bd_addr_t phone = {0x98, 0x60, 0xca, 0xd9, 0xf9, 0x79}; //TODO: randomize BT addresses before commit & push
esp_bd_addr_t phone2 = {0x18, 0x54, 0xcf, 0x6a, 0xae, 0xc4}; //TODO: randomize BT addresses before commit & push
esp_bd_addr_t presence_addr_list[2] = {};
int presence_addr_list_count = 2;
presence_data result_list[2];
#define TAG "Twomes presence detection library"
